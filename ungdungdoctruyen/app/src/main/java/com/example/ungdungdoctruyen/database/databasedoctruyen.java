...
//Insert dữ liệu vào bảng tk
    ...
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'minhtao','123','khuatquangminhvtp@gmail.com',1)";
//Insert truyện
...
//thực hienj các câu lệnh truy vấn không trả về kết quả
        db.execSQL(SQLQuery);
    ...
    //Tạo CSDL thành công gồm 2 bảng
    //dk phương thức add tài khoản vào database
